...
class Spreadsheet:
    ...
    def __init__(
        ...
        properties: Dict[str, Union[str, Any]],
    ):
    ...
    def values_batch_get(
        ...
        :rtype: dict
        """
        return self.client.values_batch_get(
    ...
    def values_update(
        ...
        .. versionadded:: 3.0
        """
        return self.client.values_update(
            self.id, range, params=params, body=body
        )
    ...
    def fetch_sheet_metadata(
        ...
        :rtype: dict
        """
        return self.client.fetch_sheet_metadata(
    ...
    def get_worksheet_by_id(self, id: Union[str, int]) -> Worksheet:
        ...
        try:
            item = finditem(
                lambda x: x["properties"]["sheetId"]
                == worksheet_id_int,
                sheet_data["sheets"],
            )
            return Worksheet(
                self, item["properties"], self.id, self.client
            )
        except (StopIteration, KeyError):
            raise WorksheetNotFound(
                "id {} not found".format(worksheet_id_int)
            )
    ...
    def worksheets(
        ...
        if exclude_hidden:
            worksheets = [
                w for w in worksheets if not w.isSheetHidden
            ]
        return worksheets
    ...
    def add_worksheet(
        ...
        if index is not None:
            body["requests"][0]["addSheet"]["properties"][
                "index"
            ] = index
    ...
    def del_worksheet(self, worksheet: Worksheet) -> Any:
        ...
        """
        body = {
            "requests": [{"deleteSheet": {"sheetId": worksheet.id}}]
        }

        return self.client.batch_update(self.id, body)

    def del_worksheet_by_id(
        ...
        body = {
            "requests": [
                {"deleteSheet": {"sheetId": worksheet_id_int}}
            ]
        }
    ...
    def export(
        self, format: ExportFormat = ExportFormat.PDF
    ) -> bytes:
    ...
    def list_named_ranges(self) -> List[Any]:
        ...
        return self.fetch_sheet_metadata(
    ...
    def list_protected_ranges(self, sheetid: int) -> List[Any]:
        ...
        try:
            ...
            raise WorksheetNotFound(
                "worksheet id {} not found".format(sheetid)
            )

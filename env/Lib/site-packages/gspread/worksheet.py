...
BatchData = TypedDict(
    "BatchData", {"range": str, "values": List[List[Any]]}
)
...
class ValueRange(list):
    ...
    @classmethod
    def from_json(
        cls: Type[ValueRangeType], json: Mapping[str, Any]
    ) -> ValueRangeType:
...
class Worksheet:
    ...
    def frozen_row_count(self) -> int:
        ...
        return self._properties["gridProperties"].get(
            "frozenRowCount", 0
        )
    ...
    def get_tab_color(self) -> Optional[str]:
        ...
        tab_color = self._properties.get("tabColorStyle", {}).get(
            "rgbColor", None
        )
    ...
    def _get_sheet_property(
        self, property: str, default_value: Optional[T]
    ) -> T:
        ...
        sheet = finditem(
            lambda x: x["properties"]["sheetId"] == self.id,
            meta["sheets"],
        )
    ...
    def cell(
        ...
        try:
            ...
            if isinstance(data, ValueRange):
                ...
                raise RuntimeError(
                    "returned data must be of type ValueRange"
                )
    ...
    def range(self, name: str = "") -> List[Cell]:
        ...
        data = self.client.values_get(
            self.spreadsheet_id, range_label
        )
    ...
    def get_all_records(
        ...
        if expected_headers is None:
            ...
            expected_headers_are_unique = len(
                expected_headers
            ) == len(set(expected_headers))
    ...
    def update_cell(
        ...
        range_name = absolute_range_name(
            self.title, rowcol_to_a1(row, col)
        )
    ...
    def get(
        ...
        if combine_merged_cells is True:
            spreadsheet_meta = self.client.fetch_sheet_metadata(
                self.spreadsheet_id
            )
        ...
        if return_type is GridRangeType.ListOfLists:
            return values
        raise ValueError(
            "return_type must be either ValueRange or ListOfLists"
        )
    ...
    def batch_get(
        ...
        """
        ranges = [
            absolute_range_name(self.title, r) for r in ranges if r
        ]
        ...
        return [
            ValueRange.from_json(x) for x in response["valueRanges"]
        ]
    ...
    def update(
        ...
        response_value_render_option: Optional[
            ValueRenderOption
        ] = None,
        response_date_time_render_option: Optional[
            DateTimeOption
        ] = None,
    ) -> JSONResponse:
        ...
        .. versionadded:: 3.3
        """
        if isinstance(range_name, (list, tuple)) and isinstance(
            values, str
        ):
            warnings.warn(
    ...
    def batch_update(
        ...
        for values in data:
            values["range"] = absolute_range_name(
                self.title, values["range"]
            )
    ...
    def batch_format(self, formats: List[CellFormat]) -> JSONResponse:
        ...
        for format in formats:
            ...
            fields = "userEnteredFormat(%s)" % ",".join(
                cell_format.keys()
            )
    ...
    def format(
        ...
        formats = [
            CellFormat(range=range, format=format)
    ...
    def resize(
        ...
        if not grid_properties:
            raise TypeError(
                "Either 'rows' or 'cols' should be specified."
            )
    ...
    def sort(
        self,
        *specs: Tuple[int, Literal["asc", "des"]],
        ...
        if range:
            ...
            start_row = (
                self._properties["gridProperties"].get(
                    "frozenRowCount", 0
                )
                + 1
            )
    ...
    def columns_auto_resize(
        ...
        return self._auto_resize(
            start_column_index, end_column_index, Dimension.cols
        )
    ...
    def rows_auto_resize(
        ...
        """
        return self._auto_resize(
            start_row_index, end_row_index, Dimension.rows
        )
    ...
    def append_rows(
        ...
        res = self.client.values_append(
            self.spreadsheet_id, range_label, params, body
        )
    ...
    def insert_rows(
        ...
        self.client.batch_update(
            self.spreadsheet_id, insert_dimension_body
        )
    ...
    def insert_cols(
        ...
        range_label = absolute_range_name(
            self.title, rowcol_to_a1(1, col)
        )
        ...
        self._properties["gridProperties"][
            "columnCount"
        ] += num_new_cols
        return res
    ...
    def delete_rows(
        ...
        """
        return self.delete_dimension(
            Dimension.rows, start_index, end_index
        )
    ...
    def delete_columns(
        ...
        """
        return self.delete_dimension(
            Dimension.cols, start_index, end_index
        )
    ...
    def batch_clear(self, ranges: Sequence[str]) -> JSONResponse:
        ...
        """
        ranges = [
            absolute_range_name(self.title, rng) for rng in ranges
        ]

        body = {"ranges": ranges}

        response = self.client.values_batch_clear(
            self.spreadsheet_id, body=body
        )
    ...
    def _finder(
        self,
        func: Callable[
            [Callable[[Cell], bool], Iterable[Cell]], Iterator[Cell]
        ],
    ...
    def find(
        ...
        try:
            return next(
                self._finder(
                    filter, query, case_sensitive, in_row, in_column
                )
            )
    ...
    def _duplicate(
        ...
        properties = data["replies"][0]["duplicateSheet"][
            "properties"
        ]

        return Worksheet(
            spreadsheet, properties, spreadsheet_id, client
        )
    ...
    def get_notes(
        self, default_empty_value: Optional[str] = ""
    ) -> List[List[str]]:
        ...
        res = self.client.spreadsheets_get(
            self.spreadsheet_id, params
        )
        data = res["sheets"][self.index]["data"][0].get(
            "rowData", [{}]
        )
        notes: List[List[str]] = []
        for row in data:
            ...
            for cell in row.get("values", []):
                notes[-1].append(
                    cell.get("note", default_empty_value)
                )
    ...
    def get_note(self, cell: str) -> str:
        ...
        try:
            note = res["sheets"][0]["data"][0]["rowData"][0][
                "values"
            ][0]["note"]
    ...
    def delete_dimension_group_columns(
        ...
        return self._delete_dimension_group(
            start, end, Dimension.cols
        )

    def delete_dimension_group_rows(
        self, start: int, end: int
    ) -> JSONResponse:
        """
    ...
    def _set_gridlines_hidden_flag(
        self, hidden: bool
    ) -> JSONResponse:
    ...
    def copy_range(
        ...
        body = {
            "requests": [
                {
                    "copyPaste": {
                        "source": a1_range_to_grid_range(
                            source, self.id
                        ),
                        "destination": a1_range_to_grid_range(
                            dest, self.id
                        ),

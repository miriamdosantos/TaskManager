...
SPREADSHEETS_API_V4_BASE_URL: str = (
    "https://sheets.googleapis.com/v4/spreadsheets"
)
SPREADSHEET_URL: str = SPREADSHEETS_API_V4_BASE_URL + "/%s"
SPREADSHEET_BATCH_UPDATE_URL: str = (
    SPREADSHEETS_API_V4_BASE_URL + "/%s:batchUpdate"
)
SPREADSHEET_VALUES_URL: str = (
    SPREADSHEETS_API_V4_BASE_URL + "/%s/values/%s"
)
SPREADSHEET_VALUES_BATCH_URL: str = (
    SPREADSHEETS_API_V4_BASE_URL + "/%s/values:batchGet"
)
...
SPREADSHEET_VALUES_APPEND_URL: str = (
    SPREADSHEET_VALUES_URL + ":append"
)
SPREADSHEET_VALUES_CLEAR_URL: str = SPREADSHEET_VALUES_URL + ":clear"
SPREADSHEET_SHEETS_COPY_TO_URL: str = (
    SPREADSHEET_URL + "/sheets/%s:copyTo"
)

DRIVE_FILES_API_V3_URL: str = (

...
quoted_string = (
    pp.dblQuotedString.copy()
    .setName("quoted-string")
    .setParseAction(unquote)
)
auth_param_name = (
    token.copy()
    .setName("auth-param-name")
    .addParseAction(downcaseTokens)
)
auth_param = (
    auth_param_name + pp.Suppress("=") + (quoted_string | token)
)
...
def _parse_authentication_info(
    headers, headername="authentication-info"
):

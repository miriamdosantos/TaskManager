    ...
    class _LiteralGenericAlias(typing._GenericAlias, _root=True):
        def __eq__(self, other):
            ...
            these_args_deduped = set(
                _value_and_type_iter(self.__args__)
            )
        ...
        def __hash__(self):
            return hash(
                frozenset(_value_and_type_iter(self.__args__))
            )
...
if sys.version_info >= (3, 13, 0, "beta"):
    ...
    class _SpecialGenericAlias(
        _special_generic_alias_base, _root=True
    ):
        def __init__(
            self,
            origin,
            ...
            *,
            ...
            if _special_generic_alias_base is typing._GenericAlias:
                ...
                # Python >= 3.9
                super().__init__(
                    origin, nparams, inst=inst, name=name
                )
...
if sys.version_info >= (3, 13):
    ...
    def runtime_checkable(cls):
        ...
        if isinstance(cls, _ProtocolMeta) or sys.version_info >= (
            3,
            12,
            2,
        ):
...
if _PEP_728_IMPLEMENTED:
    ...
    class _TypedDictMeta(type):
        def __new__(
            cls, name, bases, ns, *, total=True, closed=False
        ):
            ...
            for base in bases:
                ...
                annotations.update(
                    base_dict.get("__annotations__", {})
                )
                required_keys.update(
                    base_dict.get("__required_keys__", ())
                )
                optional_keys.update(
                    base_dict.get("__optional_keys__", ())
                )
                readonly_keys.update(
                    base_dict.get("__readonly_keys__", ())
                )
                mutable_keys.update(
                    base_dict.get("__mutable_keys__", ())
                )
                base_extra_items_type = base_dict.get(
            ...
            if closed and "__extra_items__" in own_annotations:
                annotation_type = own_annotations.pop(
                    "__extra_items__"
                )
                qualifiers = set(
                    _get_typeddict_qualifiers(annotation_type)
                )
    ...
    def TypedDict(
        ...
        **kwargs,
        ...
        if fields is _marker or fields is None:
            ...
            warnings.warn(
                deprecation_msg, DeprecationWarning, stacklevel=2
            )
        ...
        td = _TypedDictMeta(
            typename, (), ns, total=total, closed=closed
        )
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _strip_extras(t):
        ...
        if isinstance(t, typing._GenericAlias):
            stripped_args = tuple(
                _strip_extras(a) for a in t.__args__
            )
        ...
        if hasattr(_types, "UnionType") and isinstance(
            t, _types.UnionType
        ):
            stripped_args = tuple(
                _strip_extras(a) for a in t.__args__
...
# 3.8-3.9
    ...
    def get_args(tp):
        ...
        if isinstance(
            tp, (typing._GenericAlias, _typing_GenericAlias)
        ):
        ...
        def __new__(
            ...
            *constraints,
            ...
            def _tvar_prepare_subst(alias, args):
                if (
                    typevar.has_default()
                    and alias.__parameters__.index(typevar)
                    == len(args)
                ):
        ...
        def __new__(
            ...
            *,
            ...
            def _paramspec_prepare_subst(alias, args):
                ...
                if len(params) == 1 and not typing._is_param_expr(
                    args[0]
                ):
                    assert i == 0
                    args = (args,)
            ...
            paramspec.__typing_prepare_subst__ = (
...
if sys.version_info >= (
    ...
    class _UnpackAlias(typing._GenericAlias, _root=True):
        ...
        def __typing_unpacked_tuple_args__(self):
            ...
            (arg,) = self.__args__
            if isinstance(
                arg, (typing._GenericAlias, _types.GenericAlias)
            ):
...
if _PEP_696_IMPLEMENTED:
    ...
    def _unpack_args(*args):
        ...
        for arg in args:
            ...
            if subargs is not None and not (
                subargs and subargs[-1] is ...
            ):
...
if hasattr(typing, "reveal_type"):  # 3.11+
    ...
    def reveal_type(obj: T, /) -> T:
        ...
        """
        print(
            f"Runtime type is {type(obj).__name__!r}", file=sys.stderr
        )
        return obj
        ...
        def __call__(self, arg: _T, /) -> _T:
            ...
            if category is None:
                ...
                def __new__(cls, *args, **kwargs):
                    ...
                    elif cls.__init__ is object.__init__ and (
                        args or kwargs
                    ):
                        raise TypeError(
                ...
                if isinstance(original_init_subclass, MethodType):
                    ...
                    arg.__init_subclass__ = classmethod(
                        __init_subclass__
                    )
...
if not hasattr(typing, "TypeVarTuple"):
    ...
    def _check_generic(cls, parameters, elen=_marker):
        ...
        if elen is _marker:
            if (
                not hasattr(cls, "__parameters__")
        ...
        if alen != elen:
            ...
            if hasattr(cls, "__parameters__"):
                ...
                if (num_tv_tuples > 0) and (
                    alen >= elen - num_tv_tuples
                ):
                    return
                ...
                if alen < elen:
                    ...
                    if (
                        getattr(
                            parameters[alen], "__default__", NoDefault
                        )
                        is not NoDefault
                    ):
                        return
...
if sys.version_info >= (3, 13):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns):
            ...
            bases = tuple(
                tuple if base is _NamedTuple else base
                for base in bases
            )
            if "__annotations__" in ns:
            ...
            if typing.Generic in bases:
                if hasattr(typing, "_generic_class_getitem"):  # 3.12+
                    ...
                    class_getitem = (
                        typing.Generic.__class_getitem__.__func__
                    )
                    nm_tpl.__class_getitem__ = classmethod(
                        class_getitem
                    )

...
from pyflakes.test.test_undefined_names import (
    Test as TestUndefinedNames,
)
...
class Test(TestCase):
    ...
    def test_scope_class(self):
        ...
        module_scopes = [
            scope
            for scope in scopes
            if scope.__class__ is ModuleScope
        ]
        doctest_scopes = [
            scope
            for scope in scopes
            if scope.__class__ is DoctestScope
        ]
        function_scopes = [
            scope
            for scope in scopes
            if scope.__class__ is FunctionScope
        ]

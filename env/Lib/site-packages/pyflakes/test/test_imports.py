...
class Test(TestCase):
    ...
    def test_unusedImport(self):
        ...
        self.flakes(
            "from baz import fu, bar", m.UnusedImport, m.UnusedImport
        )
    ...
    def test_unusedImport_relative(self):
        ...
        checker = self.flakes(
            "from . import fu as baz", m.UnusedImport
        )
    ...
    def test_redefinedWhileUnused(self):
        ...
        self.flakes(
            "import fu; [fu, bar] = 3", m.RedefinedWhileUnused
        )

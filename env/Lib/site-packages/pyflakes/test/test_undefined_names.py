...
class Test(TestCase):
    ...
    def test_undefinedExceptionNameObscuringLocalVariableFalsePositive1(
        self,
    ):
    ...
    def test_undefinedExceptionNameObscuringLocalVariableFalsePositive2(
        self,
    ):
        """Exception names obscure locals, can't be used after. Unless.
    ...
    def test_undefinedExceptionNameObscuringGlobalVariableFalsePositive1(
        self,
    ):
    ...
    def test_undefinedExceptionNameObscuringGlobalVariableFalsePositive2(
        self,
    ):
        """Exception names obscure globals, can't be used after. Unless.

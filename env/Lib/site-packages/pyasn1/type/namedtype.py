    ...
    *namedTypes: :class:`~pyasn1.type.namedtype.NamedType`
    ...
    def __init__(self, *namedTypes, **kwargs):
        ...
        self.__ambiguousTypes = (
            "terminal" not in kwargs
            and self.__computeAmbiguousTypes()
            or {}
        )
    ...
    def __repr__(self):
        representation = ", ".join(
            ["%r" % x for x in self.__namedTypes]
        )
    ...
    def __computeAmbiguousTypes(self):
        ...
        for idx, namedType in reversed(
            tuple(enumerate(self.__namedTypes))
        ):
    ...
    def getPositionNearType(self, tagSet, idx):
        ...
        """
        try:
            return idx + self.__ambiguousTypes[idx].getPositionByType(
                tagSet
            )

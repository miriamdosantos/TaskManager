    ...
    def isSameTypeWith(
        ...
        return (
            ...
            and (
                ...
                or self.subtypeSpec == other.subtypeSpec
            )
        )
        ...
        if cls._instance is None:
            ...
            def getPlug(name):
                def plug(self, *args, **kw):
                    raise error.PyAsn1Error(
                        'Attempted "%s" operation on ASN.1 schema object'
                        % name
                    )
...
class SimpleAsn1Type(Asn1Type):
    ...
    def __init__(self, value=noValue, **kwargs):
        ...
        if value is noValue:
            ...
            try:
                ...
                raise type(exValue)(
                    "%s at %s" % (exValue, self.__class__.__name__)
                )
    ...
    def subtype(self, value=noValue, **kwargs):
        ...
        if implicitTag is not None:
            initializers["tagSet"] = self.tagSet.tagImplicitly(
                implicitTag
            )

        explicitTag = kwargs.pop("explicitTag", None)
        if explicitTag is not None:
            initializers["tagSet"] = self.tagSet.tagExplicitly(
                explicitTag
            )
...
class ConstructedAsn1Type(Asn1Type):
    ...
    def setComponentByPosition(
        self, idx, value, verifyConstraints=True
    ):
        raise error.PyAsn1Error("Method not implemented")

...
class BitStringPayloadDecoder(AbstractScalarPayloadDecoder):
    def __call__(self, pyObject, asn1Spec, decodeFun=None, **options):
        return asn1Spec.clone(
            univ.BitString.fromBinaryString(pyObject)
        )
        ...
        for field in asn1Value:
            if field in pyObject:
                asn1Value[field] = decodeFun(
                    pyObject[field],
                    componentsTypes[field].asn1Object,
                    **options,
                )
...
class SingleItemDecoder(object):
    ...
    def __call__(self, pyObject, asn1Spec, **options):
        ...
        if asn1Spec is None or not isinstance(
            asn1Spec, base.Asn1Item
        ):
...
class Decoder(object):
    ...
    def __call__(self, pyObject, asn1Spec=None, **kwargs):
        return self._singleItemDecoder(
            pyObject, asn1Spec=asn1Spec, **kwargs
        )

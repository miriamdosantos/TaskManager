...
class TimeEncoderMixIn(object):
    ...
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        ...
        if self.DOT_CHAR in numbers:
            ...
            searchIndex = min(
                numbers.index(self.DOT_CHAR) + 4, len(numbers) - 1
            )
...
class GeneralizedTimeEncoder(
    TimeEncoderMixIn, encoder.OctetStringEncoder
):
    MIN_LENGTH = 12
    MAX_LENGTH = 20
...
class SetEncoder(encoder.SequenceEncoder):
    ...
    def _componentSortKey(componentAndType):
        ...
        if (
            asn1Spec.typeId == univ.Choice.typeId
    ...
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        ...
        for comp, compType in sorted(
            comps, key=self._componentSortKey
        ):

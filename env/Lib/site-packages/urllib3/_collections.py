...
def ensure_can_construct_http_header_dict(
    ...
    if isinstance(potential, HTTPHeaderDict):
        ...
        # is the right shape.
        return typing.cast(
            typing.Iterable[typing.Tuple[str, str]], potential
        )
    elif hasattr(potential, "keys") and hasattr(
        potential, "__getitem__"
    ):
...
class HTTPHeaderDictItemView(typing.Set[typing.Tuple[str, str]]):
    ...
    def __contains__(self, item: object) -> bool:
        if isinstance(item, tuple) and len(item) == 2:
            ...
            if isinstance(passed_key, str) and isinstance(
                passed_val, str
            ):
...
class HTTPHeaderDict(typing.MutableMapping[str, str]):
    ...
    def __eq__(self, other: object) -> bool:
        maybe_constructable = ensure_can_construct_http_header_dict(
            other
        )
        if maybe_constructable is None:
            return False
        else:
            other_as_http_header_dict = type(self)(
                maybe_constructable
            )
    ...
    def extend(
        self, *args: ValidHTTPHeaderSource, **kwargs: str
    ) -> None:
        ...
        if isinstance(other, HTTPHeaderDict):
            ...
            other = typing.cast(
                typing.Iterable[typing.Tuple[str, str]], other
            )
    ...
    def _has_value_for_header(
        ...
        if header_name in self:
            return (
                potential_value
                in self._container[header_name.lower()][1:]
            )
        return False

...
if hasattr(ssl, "PROTOCOL_TLSv1_1") and hasattr(
    OpenSSL.SSL, "TLSv1_1_METHOD"
):
    _openssl_versions[ssl.PROTOCOL_TLSv1_1] = (
        OpenSSL.SSL.TLSv1_1_METHOD
    )

if hasattr(ssl, "PROTOCOL_TLSv1_2") and hasattr(
    OpenSSL.SSL, "TLSv1_2_METHOD"
):
    _openssl_versions[ssl.PROTOCOL_TLSv1_2] = (
        OpenSSL.SSL.TLSv1_2_METHOD
    )
...
_OP_NO_SSLv2_OR_SSLv3: int = getattr(
    OpenSSL.SSL, "OP_NO_SSLv2", 0
) | getattr(OpenSSL.SSL, "OP_NO_SSLv3", 0)
...
class PyOpenSSLContext:
    ...
    def wrap_socket(
        ...
        if server_hostname and not util.ssl_.is_ipaddress(
            server_hostname
        ):

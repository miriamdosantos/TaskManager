...
class MSVCCompiler(CCompiler):
    ...
    def initialize(self, plat_name=None):
        ...
        if plat_name not in PLAT_TO_VCVARS:
            raise DistutilsPlatformError(
                "--plat-name must be one of {}".format(
                    tuple(PLAT_TO_VCVARS)
                )
            )
    ...
    def object_filenames(
        ...
        def make_out_path(p):
            ...
            try:
                ...
                # different lengths
                raise CompileError(
                    "Don't know how to compile {}".format(p)
                )
    ...
    def compile(
        ...
        for obj in objects:
            ...
            if ext in self._c_extensions:
                ...
                raise CompileError(
                    "Don't know how to compile {} to {}".format(
                        src, obj
                    )
                )
    ...
    def create_static_lib(
        ...
        if self._need_link(objects, output_filename):
            ...
            try:
                log.debug(
                    'Executing "%s" %s', self.lib, " ".join(lib_args)
                )

...
class UnixCCompiler(CCompiler):
    ...
    static_lib_format = shared_lib_format = dylib_lib_format = (
        "lib%s%s"
    )
    ...
    def preprocess(
        ...
        fixed_args = self._fix_compile_args(
    ...
    def find_library_file(self, dirs, lib, debug=0):
        ...
        xcode_stub_f = self.library_filename(
            lib, lib_type="xcode_stub"
        )
        ...
        for dir in dirs:
            ...
            if sys.platform == "darwin" and (
                ...
                xcode_stub = os.path.join(
                    sysroot, dir[1:], xcode_stub_f
                )

...
class bdist_rpm(Command):
        ...
        if isinstance(self.doc_files, list):
            for readme in ("README", "README.txt"):
                if (
                    ...
                    and readme not in self.doc_files
                ):
        ...
        try:
            ...
            if status:
                raise DistutilsExecError(
                    "Failed to execute: %s" % repr(q_cmd)
                )
    ...
    def _make_spec_file(self):
        ...
        vendor_hook = subprocess.getoutput(
        ...
        spec_file.extend(
            [
                "License: "
                + (self.distribution.get_license() or "UNKNOWN"),
                "Group: " + self.group,
        ...
        if self.build_requires:
            spec_file.append(
                "BuildRequires: " + " ".join(self.build_requires)
            )

...
Target = TypeVar(
    "Target", bound=Union["Distribution", "DistributionMetadata"]
)
    ...
    def parse(self):
        ...
        for section_name, section_options in self.sections.items():
            ...
            section_parser_method: Optional[Callable] = getattr(
                ...
                ("parse_section%s" % method_postfix).replace(
                    ".", "__"
                ),
                None,
            )
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def _parse_requirements_list(self, value):
        ...
        parsed = self._parse_list_semicolon(
            self._parse_file_in_root(value)
        )
    ...
    def parse_section_package_data(self, section_options):
        ...
        :param dict section_options:
        """
        self["package_data"] = self._parse_package_data(
            section_options
        )
    ...
    def parse_section_data_files(self, section_options):
        ...
        self["data_files"] = expand.canonic_data_files(
            parsed, self.root_dir
        )

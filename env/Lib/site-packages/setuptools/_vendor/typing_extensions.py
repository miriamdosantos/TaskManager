...
# 3.6
    ...
    class _Final(typing._FinalTypingBase, _root=True):
        ...
        def _eval_type(self, globalns, localns):
            new_tp = typing._eval_type(
                self.__type__, globalns, localns
            )
...
def _get_protocol_attrs(cls):
    ...
    for base in cls.__mro__[:-1]:  # without object
        ...
        for attr in list(base.__dict__.keys()) + list(
            annotations.keys()
        ):
...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        def __class_getitem__(cls, params):
            ...
            params = tuple(
                typing._type_check(p, msg) for p in params
            )  # noqa
            if cls is Protocol:
                # Generic can only be subscripted with unique type variables.
                if not all(
                    isinstance(p, typing.TypeVar) for p in params
                ):
                    i = 0
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __new__(
            ...
            if tvars is not None:
                ...
                assert all(
                    isinstance(t, typing.TypeVar) for t in tvars
                ), tvars
            else:
            ...
            if any(
                ...
                bases = tuple(
                    b for b in bases if b is not typing.Generic
                )
            namespace.update(
                {"__origin__": origin, "__extra__": extra}
            )
        ...
        def __instancecheck__(self, instance):
            ...
            if self._is_protocol:
                if all(
                    ...
                    return True
            return super(GenericMeta, self).__instancecheck__(
                instance
            )
        ...
        def __subclasscheck__(self, cls):
            ...
            if self.__dict__.get(
                ...
                if sys._getframe(1).f_globals["__name__"] in [
                    ...
                    return super(GenericMeta, self).__subclasscheck__(
                        cls
                    )
                raise TypeError(
                    "Protocols with non-method members"
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        def __new__(cls, *args, **kwds):
            ...
            return typing._generic_new(
                cls.__next_in_mro__, cls, *args, **kwds
            )
...
if sys.version_info >= (3, 9, 2):
    ...
    def _dict_new(*args, **kwargs):
        ...
        _, args = (
            args[0],
            args[1:],
        )  # allow the "cls" keyword be passed
    ...
    def _typeddict_new(*args, total=True, **kwargs):
        ...
        if args:
            try:
                (fields,) = (
                    args  # allow the "_fields" keyword be passed
                )
            except ValueError:
                raise TypeError(
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, total=True):
            ...
            for base in bases:
                annotations.update(
                    base.__dict__.get("__annotations__", {})
                )
...
# 3.7-3.8
    ...
    def _strip_annotations(t):
        ...
        if isinstance(t, typing._GenericAlias):
            stripped_args = tuple(
                _strip_annotations(a) for a in t.__args__
            )
...
# 3.6
    ...
    class _ConcatenateAliasBase(
        ...
        def __instancecheck__(self, obj):
            raise TypeError(
                "Concatenate cannot be used with isinstance()."
            )

        def __subclasscheck__(self, cls):
            raise TypeError(
                "Concatenate cannot be used with issubclass()."
            )
...
if hasattr(typing, "Required"):
    ...
    class _MaybeRequired(typing._FinalTypingBase, _root=True):
        ...
        def __getitem__(self, item):
            ...
            raise TypeError(
                "{} cannot be further subscripted".format(
                    cls.__name__[1:]
                )
            )

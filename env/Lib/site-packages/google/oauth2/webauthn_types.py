    ...
    def from_json(json_str: str):
        ...
        try:
            ...
            raise exceptions.MalformedError(
                "Invalid Get JSON response"
            )
        if resp_json.get("type") != "getResponse":
            raise exceptions.MalformedError(
                "Invalid Get response type: {}".format(
                    resp_json.get("type")
                )
            )
        ...
        return GetResponse(
            ...
            authenticator_attachment=pk_cred.get(
                "authenticatorAttachment"
            ),
            client_extension_results=pk_cred.get(

...
class SecurityKeyChallenge(ReauthChallenge):
    ...
    def obtain_challenge_input(self, metadata):
        ...
        try:
            factory = (
                webauthn_handler_factory.WebauthnHandlerFactory()
            )
            ...
            if webauthn_handler is not None:
                ...
                return self._obtain_challenge_input_webauthn(
                    metadata, webauthn_handler
                )
        except Exception:
    ...
    def _obtain_challenge_input_webauthn(
        self, metadata, webauthn_handler
    ):
...
class SamlChallenge(ReauthChallenge):
    ...
    def obtain_challenge_input(self, metadata):
        ...
        raise exceptions.ReauthSamlChallengeFailError(

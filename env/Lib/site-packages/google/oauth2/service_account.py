...
class Credentials(
    ...
    def _make_authorization_grant_assertion(self):
        ...
        lifetime = datetime.timedelta(
            seconds=_DEFAULT_TOKEN_LIFETIME_SECS
        )
        expiry = now + lifetime
    ...
    def _use_self_signed_jwt(self):
        ...
        return (
            ...
            and self._jwt_credentials is not None
        )
        ...
        if self._always_use_jwt_access:
            if self._scopes:
                ...
                if (
                    ...
                    or self._jwt_credentials.additional_claims
                    != additional_claims
                ):
                    self._jwt_credentials = (
                ...
                if (
                    self._jwt_credentials is None
                    or additional_claims
                    != self._jwt_credentials.additional_claims
                ):
                    self._jwt_credentials = (
                        jwt.Credentials.from_signing_credentials(
                            self,

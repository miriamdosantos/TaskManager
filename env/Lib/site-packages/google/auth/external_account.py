...
class Credentials(
    ...
    def __init__(
        ...
        self._workforce_pool_user_project = (
        ...
        self._sts_client = sts.Client(
            self._token_url, self._client_auth
        )
        ...
        if (
            not self.is_workforce_pool
            and self._workforce_pool_user_project
        ):
    ...
    def _constructor_args(self):
        args = {
            ...
            or None,
            "credential_source": copy.deepcopy(
    ...
    def retrieve_subject_token(self, request):
        ...
        raise NotImplementedError(
            "retrieve_subject_token must be implemented"
        )
    ...
    def get_project_id(self, request):
        ...
        project_number = (
            self.project_number or self._workforce_pool_user_project
        )

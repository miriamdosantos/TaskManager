...
from google.auth.transport._requests_base import (
...
class TimeoutGuard(object):
    ...
    def __init__(
        self, timeout, timeout_error_type=requests.exceptions.Timeout
    ):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if isinstance(self._timeout, numbers.Number):
            ...
            self.remaining_timeout = tuple(
                x - elapsed for x in self._timeout
            )
...
class _MutualTlsAdapter(requests.adapters.HTTPAdapter):
    ...
    def init_poolmanager(self, *args, **kwargs):
        ...
        super(_MutualTlsAdapter, self).init_poolmanager(
            *args, **kwargs
        )

    def proxy_manager_for(self, *args, **kwargs):
        kwargs["ssl_context"] = self._ctx_proxymanager
        return super(_MutualTlsAdapter, self).proxy_manager_for(
            *args, **kwargs
        )
...
class _MutualTlsOffloadAdapter(requests.adapters.HTTPAdapter):
    ...
    def init_poolmanager(self, *args, **kwargs):
        kwargs["ssl_context"] = self._ctx_poolmanager
        super(_MutualTlsOffloadAdapter, self).init_poolmanager(
            *args, **kwargs
        )
...
class AuthorizedSession(requests.Session, _BaseAuthorizedSession):
    ...
    def __init__(
        ...
        if auth_request is None:
            ...
            self._auth_request_session.mount(
                "https://", retry_adapter
            )
    ...
    def request(
        ...
        **kwargs
        ...
        request_headers = (
            headers.copy() if headers is not None else {}
        )
        ...
        auth_request = (
            ...
            if timeout is None
                ...
                self._auth_request, timeout=timeout
            )
        )
        ...
        if (
            ...
            return self.request(
                ...
                timeout=timeout,
                _credential_refresh_attempt=_credential_refresh_attempt
                + 1,
                **kwargs
            )

...
def xsrf_secret_key():
    ...
    """
    secret = memcache.get(
        XSRF_MEMCACHE_ID, namespace=OAUTH2CLIENT_NAMESPACE
    )
    if not secret:
...
class AppAssertionCredentials(client.AssertionCredentials):
    ...
    def __init__(self, scope, **kwargs):
        ...
        self._kwargs = kwargs
        self.service_account_id = kwargs.get(
    ...
    def validate(self, value):
        if value is not None and not isinstance(value, client.Flow):
            raise db.BadValueError(
                ...
                "to a FlowThreeLegged instance ({1})".format(
                    self.name, value
                )
            )
...
class CredentialsProperty(db.Property):
    ...
    def validate(self, value):
        ...
        if value is not None and not isinstance(
            ...
            raise db.BadValueError(
                "Property {0} must be convertible "
                "to a Credentials instance ({1})".format(
                    self.name, value
                )
            )
        return value
...
class StorageByKeyName(client.Storage):
    ...
    def __init__(
        self, model, key_name, property_name, cache=None, user=None
    ):
        ...
        if key_name is None:
            if user is None:
                raise ValueError(
                    "StorageByKeyName called with no "
                    "key name or user."
                )
    ...
    def _is_ndb(self):
        ...
        if isinstance(self._model, type):
            if _NDB_MODEL is not None and issubclass(
                self._model, _NDB_MODEL
            ):
                return True
        ...
        raise TypeError(
            "Model class not an NDB or DB model: {0}.".format(
                self._model
            )
        )
    ...
    def _delete_entity(self):
        ...
        if self._is_ndb():
            ...
            entity_key = db.Key.from_path(
                self._model.kind(), self._key_name
            )
    ...
    def locked_get(self):
        ...
        if credentials is None:
            ...
            if entity is not None:
                ...
                if self._cache:
                    self._cache.set(
                        self._key_name, credentials.to_json()
                    )
...
class OAuth2Decorator(object):
    ...
    def has_credentials(self):
        ...
        return (
            ...
            and not self.credentials.invalid
        )
            ...
            def get(self):
                ...
                if error:
                    ...
                    if (
                        ...
                        and credentials.token_response
                    ):
...
class OAuth2DecoratorFromClientSecrets(OAuth2Decorator):
    ...
    def __init__(
        self, filename, scope, message=None, cache=None, **kwargs
    ):
        """Constructor
        ...
        if message is not None:
            ...
            self._message = (
                "Please configure your application for OAuth 2.0."
            )


@_helpers.positional(2)
def oauth2decorator_from_clientsecrets(

...
class Option:
    ...
    def filtered_option_kwargs(self) -> dict[str, Any]:
        ...
        return {
            k: v
            for k, v in self.option_kwargs.items()
            if v is not _ARG.NO
        }
...
class OptionManager:
    ...
    def extend_default_ignore(
        self, error_codes: Sequence[str]
    ) -> None:
        ...
        """
        LOG.debug(
            "Extending default ignore list with %r", error_codes
        )
        self.extended_default_ignore.extend(error_codes)

    def extend_default_select(
        self, error_codes: Sequence[str]
    ) -> None:
        ...
        """
        LOG.debug(
            "Extending default select list with %r", error_codes
        )

...
class Choice(ParamType):
    ...
    def convert(
        ...
        self.fail(
            ngettext(
                ...
                value=value, choice=choices_str, choices=choices_str
            ),
            param,
            ctx,
        )
    ...
    def shell_complete(
        ...
        if self.case_sensitive:
            matched = (
                c for c in str_choices if c.startswith(incomplete)
            )
        else:
    ...
    def convert(
        ...
        self.fail(
            ngettext(
                ...
                value=value, format=formats_str, formats=formats_str
            ),
            param,
            ctx,
        )
...
class _NumberRangeBase(_NumberParamTypeBase):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"<{type(self).__name__} {self._describe_range()}{clamp}>"
        )
...
class Path(ParamType):
    ...
    def shell_complete(
        ...
        type = (
            "dir" if self.dir_okay and not self.file_okay else "file"
        )
...
class Tuple(CompositeParamType):
    ...
    def __init__(
        ...
        self.types: t.Sequence[ParamType] = [
    ...
    def convert(
        ...
        return tuple(
            ty(x, param, ctx) for ty, x in zip(self.types, value)
        )

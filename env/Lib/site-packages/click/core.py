...
def batch(
    iterable: t.Iterable[V], batch_size: int
) -> t.List[t.Tuple[V, ...]]:
...
class Context:
    ...
    def with_resource(
        self, context_manager: t.ContextManager[V]
    ) -> V:
    ...
    def _make_sub_context(self, command: "Command") -> "Context":
        ...
        """
        return type(self)(
            command, info_name=command.name, parent=self
        )
...
class BaseCommand:
    ...
    def __init__(
        ...
        self.context_settings: t.MutableMapping[str, t.Any] = (
            context_settings
        )
    ...
    def shell_complete(
        ...
        while ctx.parent is not None:
            ...
            if (
                isinstance(ctx.command, MultiCommand)
    ...
    def _main_shell_completion(
        ...
        if complete_var is None:
            complete_name = prog_name.replace("-", "_").replace(
                ".", "_"
            )
...
class MultiCommand(Command):
    ...
    def result_callback(
        ...
        def decorator(f: F) -> F:
            ...
            self._result_callback = rv = update_wrapper(
                t.cast(F, function), f
            )
            return rv
    ...
    def invoke(self, ctx: Context) -> t.Any:
        def _process_result(value: t.Any) -> t.Any:
            if self._result_callback is not None:
                value = ctx.invoke(
                    self._result_callback, value, **ctx.params
                )
            return value
...
class Group(MultiCommand):
    ...
    #:
    #: .. versionadded:: 8.0
    group_class: t.Optional[
        t.Union[t.Type["Group"], t.Type[type]]
    ] = None
    ...
    def __init__(
        ...
        commands: t.Optional[
            t.Union[
                t.MutableMapping[str, Command], t.Sequence[Command]
            ]
        ] = None,
        **attrs: t.Any,
    ) -> None:
    ...
    def add_command(
        self, cmd: Command, name: t.Optional[str] = None
    ) -> None:
...
class Parameter:
    ...
    def __init__(
        ...
        required: bool = False,
        default: t.Optional[
            t.Union[t.Any, t.Callable[[], t.Any]]
        ] = None,
        callback: t.Optional[
            ...
            if check_default is not None:
                if multiple:
                    try:
                        ...
                        check_default = next(
                            _check_iter(check_default), None
                        )
                    except TypeError:
                        raise ValueError(
    ...
    def add_to_parser(
        self, parser: OptionParser, ctx: Context
    ) -> None:
        raise NotImplementedError()
...
class Option(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        super().__init__(
            param_decls, type=type, multiple=multiple, **attrs
        )
    ...
    def get_help_record(
        ...
        if extra:
            ...
            help = (
                f"{help}  [{extra_str}]" if help else f"[{extra_str}]"
            )
    ...
    def consume_value(
        ...
        if value is _flag_needs_value:
            ...
            value = [
                self.flag_value if v is _flag_needs_value else v
                for v in value
            ]
            source = ParameterSource.COMMANDLINE
...
class Argument(Parameter):
    ...
    def add_to_parser(
        ...
        parser.add_argument(
            dest=self.name, nargs=self.nargs, obj=self
        )

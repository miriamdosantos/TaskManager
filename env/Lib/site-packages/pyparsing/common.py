...
class pyparsing_common:
    ...
    mixed_integer = (
        fraction
        | signed_integer + Opt(Opt("-").suppress() + fraction)
    ...
    identifier = Word(identchars, identbodychars).set_name(
        "identifier"
    )
    ...
    _html_stripper = (
        any_open_tag.suppress() | any_close_tag.suppress()
    )
...
_builtin_exprs = [
    v
    for v in vars(pyparsing_common).values()

...
OtherRevocationInfoFormat.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "otherRevInfoFormat", univ.ObjectIdentifier()
    ),
...
IssuerAndSerialNumber.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "serialNumber", rfc3280.CertificateSerialNumber()
    ),
)
...
UnprotectedAttributes.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
AttributeCertificateInfoV1.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "attCertValidityPeriod", rfc3281.AttCertValidityPeriod()
    ),
    namedtype.NamedType(
        "attributes",
    ...
    namedtype.OptionalNamedType(
        "issuerUniqueID", rfc3280.UniqueIdentifier()
    ),
...
AttributeCertificateV1.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "signatureAlgorithm", rfc3280.AlgorithmIdentifier()
    ),

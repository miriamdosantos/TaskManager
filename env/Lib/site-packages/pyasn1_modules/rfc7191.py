...
AttributeValues.sizeSpec = (
    univ.Set.sizeSpec + constraint.ValueSizeConstraint(1, 1)
)
...
SingleAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        ...
        openType=opentype.OpenType(
            "attrType", rfc5652.cmsAttributesMap
        ),
    ),
)
...
id_ct_KP_keyPackageError = univ.ObjectIdentifier(
...
id_ct_KP_keyPackageReceipt = univ.ObjectIdentifier(

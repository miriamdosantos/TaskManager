...
id_Gost28147_89_CryptoPro_Oscar_1_1_ParamSet = (
    id_CryptoPro_encrypts + (5,)
)

id_Gost28147_89_CryptoPro_Oscar_1_0_ParamSet = (
    id_CryptoPro_encrypts + (6,)
)

id_Gost28147_89_CryptoPro_RIC_1_ParamSet = id_CryptoPro_encrypts + (
    7,
)
...
id_GostR3410_2001_CryptoPro_XchA_ParamSet = (
    id_CryptoPro_ecc_exchanges + (0,)
)

id_GostR3410_2001_CryptoPro_XchB_ParamSet = (
    id_CryptoPro_ecc_exchanges + (1,)
)
...
id_GostR3410_94_CryptoPro_XchA_ParamSet = id_CryptoPro_exchanges + (
    1,
)

id_GostR3410_94_CryptoPro_XchB_ParamSet = id_CryptoPro_exchanges + (
    2,
)

id_GostR3410_94_CryptoPro_XchC_ParamSet = id_CryptoPro_exchanges + (
    3,
)
...
Gost28147_89_Parameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "encryptionParamSet", Gost28147_89_ParamSet()
    ),
)
...
GostR3410_2001_CertificateSignature.subtypeSpec = (
    constraint.ValueSizeConstraint(256, 512)
)
...
GostR3410_2001_ParamSetParameters.componentType = (
...
GostR3410_2001_PublicKey.subtypeSpec = constraint.ValueSizeConstraint(
    64, 64
)
...
GostR3410_2001_PublicKeyParameters.componentType = (
    namedtype.NamedTypes(
        namedtype.NamedType(
            "publicKeyParamSet",
...
GostR3410_94_CertificateSignature.subtypeSpec = (
    constraint.ValueSizeConstraint(256, 512)
)
...
GostR3410_94_ParamSetParameters_t.subtypeSpec = (
    constraint.SingleValueConstraint(512, 1024)
)
...
GostR3410_94_ValidationBisParameters_c.subtypeSpec = (
...
GostR3410_94_ValidationBisParameters.componentType = (
    namedtype.NamedTypes(
        namedtype.NamedType(
            "x0", GostR3410_94_ValidationBisParameters_c()
        ),
        namedtype.NamedType(
            "c", GostR3410_94_ValidationBisParameters_c()
        ),
...
GostR3410_94_ValidationParameters_c.subtypeSpec = (
...
GostR3410_94_ValidationParameters.componentType = (
    namedtype.NamedTypes(
        namedtype.NamedType(
            "x0", GostR3410_94_ValidationParameters_c()
        ),
        namedtype.NamedType(
            "c", GostR3410_94_ValidationParameters_c()
        ),
        namedtype.OptionalNamedType("d", univ.Integer()),
    )
)
...
GostR3411_94_Digest.subtypeSpec = constraint.ValueSizeConstraint(
    32, 32
)
...
GostR3411_94_DigestParameters.subtypeSpec = (

...
FriendlyName.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "friendlyNameLangTag", char.UTF8String()
    ),
)
...
at_pskc_timeInterval.subtypeSpec = constraint.ValueRangeConstraint(
    0, MAX
)
...
at_pskc_timeDrift.subtypeSpec = constraint.ValueRangeConstraint(
    0, MAX
)
...
at_pskc_numberOfTransactions.subtypeSpec = (
...
id_ct_KP_sKeyPackage = univ.ObjectIdentifier(

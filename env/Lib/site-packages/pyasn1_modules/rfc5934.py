...
HardwareModuleIdentifierList.subtypeSpec = (
...
CommunityIdentifierList.subtypeSpec = constraint.ValueSizeConstraint(
    0, MAX
)
...
SeqNumber.subtypeSpec = constraint.ValueRangeConstraint(
...
TrustAnchorChoiceList.subtypeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
TAMPSequenceNumbers.subtypeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
TAMPStatusResponse.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "usesApex", univ.Boolean().subtype(value=1)
    ),
)
...
tamp_community_update_confirm["contentType"] = (
    id_ct_TAMP_communityUpdateConfirm
)
tamp_community_update_confirm["content"] = (
...
tamp_sequence_number_adjust_confirm["contentType"] = (
    id_ct_TAMP_seqNumAdjustConfirm
)
tamp_sequence_number_adjust_confirm["content"] = (
...
contingency_public_key_decrypt_key["type"] = (
    id_aa_TAMP_contingencyPublicKeyDecryptKey
)
contingency_public_key_decrypt_key["values"][
    0
...
id_pe_wrappedApexContinKey = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.1.20"
)

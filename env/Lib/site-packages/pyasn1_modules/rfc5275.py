...
class GLAQueryRequest(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "glaRequestType", univ.ObjectIdentifier()
        ),
        namedtype.NamedType(
            "glaRequestValue",
            univ.Any(),
            openType=opentype.OpenType(
                "glaRequestType", glaQueryRRMap
            ),
        ),
    )
...
class GLAQueryResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "glaResponseType", univ.ObjectIdentifier()
        ),
        namedtype.NamedType(
            "glaResponseValue",
            univ.Any(),
            openType=opentype.OpenType(
                "glaResponseType", glaQueryRRMap
            ),
        ),
    )

...
id_aa_KP_keyPkgIdAndReceiptReq = (
    rfc7191.id_aa_KP_keyPkgIdAndReceiptReq
)
...
id_aa_KP_keyProvinceV2 = univ.ObjectIdentifier(
...
id_kma_keyPkgReceiversV2 = univ.ObjectIdentifier(
...
id_kma_TSECNomenclature = univ.ObjectIdentifier(
...
id_kma_transportKey = univ.ObjectIdentifier(
...
id_kma_keyDistPeriod = univ.ObjectIdentifier(
...
id_kma_keyValidityPeriod = univ.ObjectIdentifier(
...
id_informativeAttributes = univ.ObjectIdentifier(
...
SecurityAttribute.subtypeSpec = constraint.ValueRangeConstraint(
    0, MAX
)
...
EnumeratedTag.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "attributeList", univ.SetOf(componentType=SecurityAttribute())
    ),
)
...
FreeFormField.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "securityAttributes",
        univ.SetOf(componentType=SecurityAttribute()),
    ),
)
...
id_kma_otherCertFormats = univ.ObjectIdentifier(
...
id_kma_keyWrapAlgorithm = univ.ObjectIdentifier(
...
id_aa_KP_contentDecryptKeyID = univ.ObjectIdentifier(
...
aa_contentDecryptKeyIdentifier["attrType"] = (
    id_aa_KP_contentDecryptKeyID
)
aa_contentDecryptKeyIdentifier["attrValues"][
    0
] = ContentDecryptKeyID()
...
id_aa_KP_crlPointers = univ.ObjectIdentifier(
...
id_privacyMarkTooLong = univ.ObjectIdentifier(

...
class TeletexOrganizationalUnitName(char.TeletexString):
    subtypeSpec = (
        char.TeletexString.subtypeSpec
        + constraint.ValueSizeConstraint(
...
id_holdinstruction_callissuer = univ.ObjectIdentifier(
    "2.2.840.10040.2.2"
)
...
class Extension(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.DefaultedNamedType(
            "critical", univ.Boolean("False")
        ),
        namedtype.NamedType(
            "extnValue",
            univ.OctetString(),
            openType=opentype.OpenType(
                "extnID", certificateExtensionsMap
            ),
        ),
    )
...
class TBSCertList(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "revokedCertificates",
            univ.SequenceOf(componentType=RevokedCertificate()),
        ),
        namedtype.OptionalNamedType(
            "crlExtensions",
            Extensions().subtype(

...
id_aa_signingCertificate = univ.ObjectIdentifier(
...
SigningCertificate.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "certs", univ.SequenceOf(componentType=ESSCertID())
    ),
...
id_aa_mlExpandHistory = univ.ObjectIdentifier(
...
id_aa_securityLabel = univ.ObjectIdentifier(
...
id_aa_equivalentLabels = univ.ObjectIdentifier(
...
id_aa_contentIdentifier = univ.ObjectIdentifier(
...
id_aa_contentReference = univ.ObjectIdentifier(
...
ContentReference.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "originatorSignatureValue", univ.OctetString()
    ),
)
...
id_aa_msgSigDigest = univ.ObjectIdentifier(
...
id_aa_receiptRequest = univ.ObjectIdentifier(

...
POPOSigningKey.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "algorithmIdentifier", rfc3280.AlgorithmIdentifier()
    ),
...
PrivateKeyInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "privateKeyAlgorithm", rfc3280.AlgorithmIdentifier()
    ),
...
CertReqMsg.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "regInfo",
        univ.SequenceOf(componentType=AttributeTypeAndValue()),
    ),
)
    ...
    namedtype.OptionalNamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                ...
                namedtype.NamedType(
                    "generalName", rfc3280.GeneralName()
                ),
            )
        ),
    ),

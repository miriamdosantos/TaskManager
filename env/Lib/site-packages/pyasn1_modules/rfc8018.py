...
RC2_CBC_Parameter.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "rc2ParameterVersion", univ.Integer()
    ),
    namedtype.NamedType(
        "iv",
        univ.OctetString().subtype(
...
RC5_CBC_Parameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "version",
        univ.Integer(
            namedValues=namedval.NamedValues(("v1_0", 16))
        ).subtype(subtypeSpec=constraint.SingleValueConstraint(16)),
    ),
    namedtype.NamedType(
        "rounds",
        univ.Integer().subtype(
            subtypeSpec=constraint.ValueRangeConstraint(8, 127)
        ),
    ),
    namedtype.NamedType(
        "blockSizeInBits",
        univ.Integer().subtype(
            subtypeSpec=constraint.SingleValueConstraint(64, 128)
        ),
    ),

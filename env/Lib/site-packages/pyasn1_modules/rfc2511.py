...
id_regCtrl_authenticator = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.5.1.2"
)
id_regCtrl_pkiPublicationInfo = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.5.1.3"
)
id_regCtrl_pkiArchiveOptions = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.5.1.4"
)
id_regCtrl_oldCertID = univ.ObjectIdentifier("1.3.6.1.5.5.7.5.1.5")
id_regCtrl_protocolEncrKey = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.5.1.6"
)

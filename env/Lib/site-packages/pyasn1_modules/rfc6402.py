...
CMCStatusInfoV2.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "bodyList", univ.SequenceOf(componentType=BodyPartReference())
    ),
...
PopLinkWitnessV2.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "keyGenAlgorithm", rfc5280.AlgorithmIdentifier()
    ),
    namedtype.NamedType(
        "macAlgorithm", rfc5280.AlgorithmIdentifier()
    ),
    ...
    namedtype.NamedType(
        ...
        univ.Sequence(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType("bodyPartID", BodyPartID()),
                namedtype.NamedType(
                    "requestMessageType", univ.ObjectIdentifier()
                ),
                namedtype.NamedType(
                    "requestMessageValue", univ.Any()
                ),
            )
        ).subtype(
            implicitTag=tag.Tag(
...
PublishTrustAnchors.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "hashAlgorithm", rfc5280.AlgorithmIdentifier()
    ),
    namedtype.NamedType(
        "anchorHashes",
...
RevokeRequest.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "invalidityDate", useful.GeneralizedTime()
    ),
...
CMCStatusInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("cMCStatus", CMCStatus()),
    namedtype.NamedType(
        "bodyList", univ.SequenceOf(componentType=BodyPartID())
    ),
    namedtype.OptionalNamedType("statusString", char.UTF8String()),
    namedtype.OptionalNamedType(
        "otherInfo",
...
TaggedAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        ...
        openType=opentype.OpenType(
            "attrType", cmcControlAttributesMap
        ),
    ),
)
...
PKIData.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "controlSequence",
        univ.SequenceOf(componentType=TaggedAttribute()),
    ),
    namedtype.NamedType(
        "reqSequence", univ.SequenceOf(componentType=TaggedRequest())
    ),
    namedtype.NamedType(
        "cmsSequence",
        univ.SequenceOf(componentType=TaggedContentInfo()),
    ),
    namedtype.NamedType(
        "otherMsgSequence", univ.SequenceOf(componentType=OtherMsg())
    ),
)
...
ModCertTemplate.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "replace", univ.Boolean().subtype(value=1)
    ),
...
LraPopWitness.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "bodyIds", univ.SequenceOf(componentType=BodyPartID())
    ),
)
...
AddExtensions.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "certReferences", univ.SequenceOf(componentType=BodyPartID())
    ),
    namedtype.NamedType(
        "extensions",
        univ.SequenceOf(componentType=rfc5280.Extension()),
    ),
)
...
EncryptedPOP.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("thePOPAlgID", rfc5280.AlgorithmIdentifier()),
    namedtype.NamedType(
        "witnessAlgID", rfc5280.AlgorithmIdentifier()
    ),
    namedtype.NamedType("witness", univ.OctetString()),
)

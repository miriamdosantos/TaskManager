...
class AttCertValidityPeriod(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "notBeforeTime", useful.GeneralizedTime()
        ),
...
class AttributeCertificateInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "attributes", univ.SequenceOf(componentType=Attribute())
        ),
        namedtype.OptionalNamedType(
        ...
        namedtype.NamedType(
            ...
            univ.SequenceOf(
                componentType=univ.Choice(
                    componentType=namedtype.NamedTypes(
                        namedtype.NamedType(
                            "octets", univ.OctetString()
                        ),
                        namedtype.NamedType(
                            "oid", univ.ObjectIdentifier()
                        ),
                        namedtype.NamedType(
                            "string", char.UTF8String()
                        ),
                    )
                )
            ),
...
class ACClearAttrs(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "attrs", univ.SequenceOf(componentType=Attribute())
        ),
    )
...
rfc5280.certificateExtensionsMap.update(
    _certificateExtensionsMapUpdate
)
...
rfc5280.certificateAttributesMap.update(
    _certificateAttributesMapUpdate
)

...
Extension.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "critical", univ.Boolean().subtype(value=0)
    ),
...
TeletexDomainDefinedAttributes.componentType = (
    TeletexDomainDefinedAttribute()
)
TeletexDomainDefinedAttributes.sizeSpec = (
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            ...
            openType=opentype.OpenType(
                "algorithm", algorithmIdentifierMap
            ),
        ),
    )
...
RelativeDistinguishedName.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
BuiltInDomainDefinedAttributes.componentType = (
    BuiltInDomainDefinedAttribute()
)
BuiltInDomainDefinedAttributes.sizeSpec = (
    constraint.ValueSizeConstraint(1, ub_domain_defined_attributes)
)
...
PDSName.subtypeSpec = constraint.ValueSizeConstraint(
...
TeletexOrganizationalUnitName.subtypeSpec = (
...
TeletexOrganizationalUnitNames.componentType = (
    TeletexOrganizationalUnitName()
)
TeletexOrganizationalUnitNames.sizeSpec = (
...
CRLDistributionPoints.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
SubjectDirectoryAttributes.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
PolicyInformation.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "policyQualifiers",
        univ.SequenceOf(componentType=PolicyQualifierInfo()),
    ),
)
...
BasicConstraints.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        "cA", univ.Boolean().subtype(value=0)
    ),
    namedtype.OptionalNamedType(
        "pathLenConstraint",
...
AuthorityInfoAccessSyntax.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
SubjectInfoAccessSyntax.sizeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
oraddressExtensionAttributeMap.update(
    _oraddressExtensionAttributeMapUpdate
)

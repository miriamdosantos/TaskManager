...
PreferredOrLegacyPackageIdentifier.componentType = (
...
PreferredOrLegacyStalePackageIdentifier.componentType = (
    namedtype.NamedTypes(
        namedtype.NamedType(
...
id_aa_wrappedFirmwareKey = univ.ObjectIdentifier(
...
id_aa_firmwarePackageInfo = univ.ObjectIdentifier(
...
FirmwarePackageInfo.sizeSpec = (
    univ.Sequence.sizeSpec + constraint.ValueSizeConstraint(1, 2)
)
...
id_aa_implCompressAlgs = univ.ObjectIdentifier(
...
id_aa_implCryptoAlgs = univ.ObjectIdentifier(
...
id_aa_decryptKeyID = univ.ObjectIdentifier(
...
id_aa_targetHardwareIDs = univ.ObjectIdentifier(
...
id_aa_firmwarePackageID = univ.ObjectIdentifier(
...
id_aa_fwPkgMessageDigest = univ.ObjectIdentifier(
...
id_ct_firmwareLoadError = univ.ObjectIdentifier(
...
id_ct_firmwareLoadReceipt = univ.ObjectIdentifier(
...
FirmwarePackageLoadReceipt.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "trustAnchorKeyID", univ.OctetString()
    ),
    namedtype.OptionalNamedType(
        "decryptKeyID",
...
id_ct_firmwarePackage = univ.ObjectIdentifier(

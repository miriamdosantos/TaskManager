...
id_etsi_es_IDUP_Mechanism_v1 = univ.ObjectIdentifier(
    "0.4.0.1733.1.4.1"
)
...
id_aa_ets_otherSigCert = univ.ObjectIdentifier(
...
class OtherSigningCertificate(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "certs", univ.SequenceOf(componentType=OtherCertID())
        ),
...
id_aa_ets_sigPolicyId = univ.ObjectIdentifier(
...
class SignaturePolicyId(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "sigPolicyQualifiers",
            univ.SequenceOf(
                componentType=SigPolicyQualifierInfo()
            ).subtype(
...
id_spq_ets_unotice = univ.ObjectIdentifier(
...
id_aa_ets_commitmentType = univ.ObjectIdentifier(
...
class CommitmentTypeIndication(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            ...
            univ.SequenceOf(
                componentType=CommitmentTypeQualifier()
            ).subtype(
                subtypeSpec=constraint.ValueSizeConstraint(1, MAX)
            ),
        ),
...
id_cti_ets_proofOfOrigin = univ.ObjectIdentifier(
    "1.2.840.113549.1.9.16.6.1"
)

id_cti_ets_proofOfReceipt = univ.ObjectIdentifier(
    "1.2.840.113549.1.9.16.6.2"
)

id_cti_ets_proofOfDelivery = univ.ObjectIdentifier(
    "1.2.840.113549.1.9.16.6.3"
)

id_cti_ets_proofOfSender = univ.ObjectIdentifier(
    "1.2.840.113549.1.9.16.6.4"
)

id_cti_ets_proofOfApproval = univ.ObjectIdentifier(
    "1.2.840.113549.1.9.16.6.5"
)

id_cti_ets_proofOfCreation = univ.ObjectIdentifier(
...
id_aa_ets_signerLocation = univ.ObjectIdentifier(
...
id_aa_ets_signerAttr = univ.ObjectIdentifier(
...
id_aa_ets_certificateRefs = univ.ObjectIdentifier(
...
id_aa_ets_revocationRefs = univ.ObjectIdentifier(
...
class CRLListID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "crls", univ.SequenceOf(componentType=CrlValidatedID())
        )
    )
...
class OtherRevRefs(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            ...
            univ.Any(),
            openType=opentype.OpenType(
                "otherRevRefType", otherRevRefMap
            ),
        ),
    )
...
id_aa_ets_certValues = univ.ObjectIdentifier(
...
class OtherRevVals(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            ...
            univ.Any(),
            openType=opentype.OpenType(
                "otherRevValType", otherRevValMap
            ),
        ),
    )
...
class RevocationValues(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "ocspVals",
            univ.SequenceOf(
                componentType=BasicOCSPResponse()
            ).subtype(
                explicitTag=tag.Tag(
                    tag.tagClassContext, tag.tagFormatSimple, 1
                )
...
id_aa_ets_escTimeStamp = univ.ObjectIdentifier(

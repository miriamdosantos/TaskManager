...
class RevDetails(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "crlEntryDetails", rfc2459.Extensions()
        ),
    )
...
class Challenge(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "owf", rfc2459.AlgorithmIdentifier()
        ),
...
class RevAnnContent(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "willBeRevokedAt", useful.GeneralizedTime()
        ),
        namedtype.NamedType("badSinceDate", useful.GeneralizedTime()),
        namedtype.OptionalNamedType(
            "crlDetails", rfc2459.Extensions()
        ),
    )
...
class CertRepMessage(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "response", univ.SequenceOf(componentType=CertResponse())
        ),
    )
...
nestedMessageContent = NestedMessageContent().subtype(
    explicitTag=tag.Tag(
        tag.tagClassContext, tag.tagFormatConstructed, 20
    )
)

...
id_ct_anyContentType = univ.ObjectIdentifier(
...
AttrConstraintList.subtypeSpec = constraint.ValueSizeConstraint(
    1, MAX
)
...
id_pe_cmsContentConstraints = univ.ObjectIdentifier(
    "1.3.6.1.5.5.7.1.18"
)
...
CMSContentConstraints.subtypeSpec = constraint.ValueSizeConstraint(
    1, MAX
)

...
id_pkix_ocsp_basic = univ.ObjectIdentifier(
    (1, 3, 6, 1, 5, 5, 7, 48, 1, 1)
)
id_pkix_ocsp_nonce = univ.ObjectIdentifier(
    (1, 3, 6, 1, 5, 5, 7, 48, 1, 2)
)
id_pkix_ocsp_crl = univ.ObjectIdentifier(
    (1, 3, 6, 1, 5, 5, 7, 48, 1, 3)
)
id_pkix_ocsp_response = univ.ObjectIdentifier(
    (1, 3, 6, 1, 5, 5, 7, 48, 1, 4)
)
id_pkix_ocsp_nocheck = univ.ObjectIdentifier(
...
class RevokedInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "revocationTime", useful.GeneralizedTime()
        ),
...
class BasicOCSPResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "signatureAlgorithm", rfc2459.AlgorithmIdentifier()
        ),

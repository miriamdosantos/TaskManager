...
class ParserGenerator:
    ...
    def make_grammar(self) -> PgenGrammar:
        ...
        for name in names:
            ...
            c.dfas[c.symbol2number[name]] = (
                states,
                self.make_first(c, name),
            )
    ...
    def make_dfa(
        ...
        return (
            states  # List of DFAState instances; first one is start
        )
    ...
    def expect(self, type: int, value: Optional[Any] = None) -> str:
        if self.type != type or (
            value is not None and self.value != value
        ):
            self.raise_error(
...
class NFAState:
    ...
    def addarc(
        self, next: "NFAState", label: Optional[str] = None
    ) -> None:

...
RawNode = tuple[
    int, Optional[str], Optional[Context], Optional[list[NL]]
]
...
class Node(Base):
    ...
    def invalidate_sibling_maps(self) -> None:
        self.prev_sibling_map: Optional[dict[int, Optional[NL]]] = (
            None
        )
        self.next_sibling_map: Optional[dict[int, Optional[NL]]] = (
            None
        )
...
class Leaf(Base):
    ...
    def __init__(
        ...
        self.fmt_pass_converted_first_leaf = (
...
class BasePattern:
    ...
    def match(
        self, node: NL, results: Optional[_Results] = None
    ) -> bool:
        """
...
class NodePattern(BasePattern):
    ...
    def __init__(
        ...
        self.type = type
        self.content = (
            newcontent  # TODO: this is unbound when content is None
        )
        self.name = name
...
class WildcardPattern(BasePattern):
    ...
    def generate_matches(
        ...
        if self.content is None:
            ...
            for count in range(
                self.min, 1 + min(len(nodes), self.max)
            ):
                r = {}
                if self.name:

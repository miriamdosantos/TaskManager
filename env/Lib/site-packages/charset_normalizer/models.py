...
class CharsetMatch:
    def __init__(
        ...
        self._preemptive_declaration: Optional[str] = (
    ...
    def __lt__(self, other: object) -> bool:
        ...
        coherence_difference: float = abs(
    ...
    def __str__(self) -> str:
        ...
        if self._string is None:
            self._string = str(
                self._payload, self._encoding, "strict"
            )
        return self._string
    ...
    def alphabets(self) -> List[str]:
        ...
        # filter and sort
        self._unicode_ranges = sorted(
            list({r for r in detected_ranges if r})
        )
        return self._unicode_ranges
    ...
    def output(self, encoding: str = "utf_8") -> bytes:
        ...
        """
        if (
            self._output_encoding is None
            or self._output_encoding != encoding
        ):
            ...
            if (
                ...
                decoded_string = (
                    patched_header + decoded_string[8192:]
                )
...
class CharsetMatches:
    ...
    def __init__(self, results: Optional[List[CharsetMatch]] = None):
        self._results: List[CharsetMatch] = (

...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def __init__(self, **options):
        ...
        self.cssfile = self._decodeifneeded(
            options.get("cssfile", "")
        )
        ...
        self.linenospecial = abs(
            get_int_opt(options, "linenospecial", 0)
        )
        self.nobackground = get_bool_opt(
            options, "nobackground", False
        )
    ...
    def get_linenos_style_defs(self):
        lines = [
            ...
            "td.linenos .special { %s }"
            % self._linenos_special_style,
            "span.linenos.special { %s }"
            % self._linenos_special_style,
        ]
    ...
    def _wrap_full(self, inner, outfile):
        if self.cssfile:
            ...
            try:
                ...
                err.strerror = (
                    "Error writing CSS file: " + err.strerror
                )
                raise
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        for i in range(fl, fl + lncount):
            ...
            if nocls:
                if special_line:
                    style = (
                        ' style="%s"' % self._linenos_special_style
                    )
                else:
    ...
    def _wrap_lineanchors(self, inner):
        ...
        for t, line in inner:
            if t:
                i += 1
                href = (
                    "" if self.linenos else ' href="#%s-%d"' % (s, i)
                )
    ...
    def _wrap_div(self, inner):
        ...
        if (
            ...
            style.append(
                "background: %s" % (self.style.background_color,)
            )
        if self.cssstyles:

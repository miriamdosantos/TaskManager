...
class FontManager:
    ...
    def _create_nix(self):
        for name in STYLES["NORMAL"]:
            ...
            raise FontNotFound(
                'No usable fonts named: "%s"' % self.font_name
            )
...
class ImageFormatter(Formatter):
    ...
    def __init__(self, **options):
        ...
        self.fonts = FontManager(
            options.get("font_name", ""), fontsize
        )
        ...
        self.line_numbers = get_bool_opt(
        ...
        for line in hl_lines_str:
            try:
                ...
                pass
        self.hl_color = (
            options.get("hl_color", self.style.highlight_color)
            or "#f90"
        )
        self.drawables = []
        ...
        for ttype, value in tokensource:
            ...
            for i, line in enumerate(lines):
                ...
                if temp:
                    ...
                    temp_width, temp_hight = self.fonts.get_text_size(
                        temp
                    )
    ...
    def _paint_line_number_bg(self, im):
        ...
        draw.rectangle(
            [(0, 0), (rectw, recth)], fill=self.line_number_bg
        )
        if self.line_number_separator:
            draw.line(
                [(rectw, 0), (rectw, recth)], fill=self.line_number_fg
            )
        del draw

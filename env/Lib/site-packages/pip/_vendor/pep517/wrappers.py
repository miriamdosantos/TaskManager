...
def norm_and_check(source_tree, requested):
    ...
    if (
        os.path.commonprefix([norm_source, norm_requested])
        != norm_source
    ):
...
class Pep517HookCaller(object):
    ...
    def __init__(
        ...
        if backend_path:
            backend_path = [
                norm_and_check(self.source_dir, p)
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        if self.backend_path:
            ...
            if sys.version_info[0] == 2:
                backend_path = backend_path.encode(
        ...
        with tempdir() as td:
            ...
            compat.write_json(
                hook_input, pjoin(td, "input.json"), indent=2
            )

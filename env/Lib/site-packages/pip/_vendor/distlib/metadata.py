    ...
    def set(self, name, value):
        ...
        if (
            ...
            if isinstance(value, string_types):
                ...
                value = []
        elif name in _LISTFIELDS and not isinstance(
            value, (list, tuple)
        ):
            if isinstance(value, string_types):
                value = [value]
        ...
        for field_name in fields:
            if not skip_missing or field_name in self._fields:
                ...
                if key != "project_url":
                    ...
                    data[key] = [
                        ",".join(u) for u in self[field_name]
                    ]
...
class Metadata(object):
    ...
    common_keys = set(
        ("name", "version", "license", "keywords", "summary")
    )
    ...
    def write(
        ...
        if legacy:
            ...
            if path:
                ...
                legacy_md.write_file(
                    fileobj, skip_unknown=skip_unknown
                )
        else:
            if self._legacy:
                d = self._from_legacy()

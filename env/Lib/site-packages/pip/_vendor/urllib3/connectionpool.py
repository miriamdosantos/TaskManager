        ...
        **response_kw
        ...
        try:
            ...
            is_new_proxy_conn = (
                ...
                and not getattr(conn, "sock", None)
            )
            ...
            def _is_ssl_error_message_from_http_proxy(ssl_error):
                ...
                message = " ".join(
                    re.split("[^a-z]", str(ssl_error).lower())
                )
                return (
            ...
            if (
                ...
                isinstance(e, (SocketError, NewConnectionError))
                and self.proxy
            ):
        ...
        # Handle redirect?
        redirect_location = (
            redirect and response.get_redirect_location()
        )
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _prepare_proxy(self, conn):
        ...
        conn.set_tunnel(
            self._proxy_host, self.port, self.proxy_headers
        )
    ...
    def _new_conn(self):
        ...
        if (
            not self.ConnectionCls
            or self.ConnectionCls is DummyConnection
        ):
            raise SSLError(

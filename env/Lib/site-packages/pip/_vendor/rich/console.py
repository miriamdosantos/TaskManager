...
class ConsoleOptions:
    ...
    def copy(self) -> "ConsoleOptions":
        ...
        """
        options: ConsoleOptions = ConsoleOptions.__new__(
            ConsoleOptions
        )
    ...
    def update(
        ...
        *,
        ...
        overflow: Union[
            Optional[OverflowMethod], NoChange
        ] = NO_CHANGE,
...
class Console:
        ...
        *,
        ...
        if self.is_jupyter:
            if width is None:
                ...
                if (
                    jupyter_columns is not None
                    and jupyter_columns.isdigit()
                ):
            ...
            if height is None:
                ...
                if (
                    jupyter_lines is not None
                    and jupyter_lines.isdigit()
                ):
        ...
        self.highlighter: HighlighterType = (
            highlighter or _null_highlighter
        )
        ...
        self.no_color = (
            ...
            else "NO_COLOR" in self._environ
        )
        self.is_interactive = (
    ...
    def __repr__(self) -> str:
        return (
            f"<console width={self.width} {str(self._color_system)}>"
        )
    ...
    def file(self) -> IO[str]:
        ...
        file = self._file or (
            sys.stderr if self.stderr else sys.stdout
        )
    ...
    def encoding(self) -> str:
        ...
        """
        return (
            getattr(self.file, "encoding", "utf-8") or "utf-8"
        ).lower()
    ...
    def pager(
        ...
        """
        return PagerContext(
            self, pager=pager, styles=styles, links=links
        )
    ...
    def screen(
        ...
        return ScreenContext(
            self, hide_cursor=hide_cursor, style=style or ""
        )
    ...
    def render(
        ...
        if hasattr(renderable, "__rich_console__") and not isclass(
            renderable
        ):
        ...
        *,
        ...
        if markup_enabled:
            ...
            rich_text = Text(
                (
                    _emoji_replace(
                        text, default_variant=self._emoji_variant
                    )
                    if emoji_enabled
                    else text
                ),
        ...
        _highlighter = (
            (highlighter or self.highlighter)
    ...
    def out(
        ...
        *objects: Any,
        ...
        """
        raw_output: str = sep.join(
            str(_object) for _object in objects
        )
        self.print(
            raw_output,
            style=style,
    ...
    def export_svg(
        ...
        *,
        ...
        with self._record_buffer_lock:
            segments = list(
                Segment.filter_control(self._record_buffer)
            )
            if clear:

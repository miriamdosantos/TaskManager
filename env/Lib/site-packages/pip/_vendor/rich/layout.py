...
class _Placeholder:
    ...
    def __init__(
        self, layout: "Layout", style: StyleType = ""
    ) -> None:
        self.layout = layout
        self.style = style
...
class Layout:
    ...
    def refresh_screen(
        self, console: "Console", layout_name: str
    ) -> None:
    ...
    def _make_region_map(self, width: int, height: int) -> RegionMap:
        ...
        region_map = {
            layout: region
            for layout, region in sorted(
                layout_regions, key=itemgetter(1)
            )
        }
        return region_map
    ...
    def render(
        ...
        region_map = self._make_region_map(

...
class UTF1632Prober(CharSetProber):
    ...
    def is_likely_utf32be(self):
        ...
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            ...
            and self.zeros_at_mod[1] / approx_chars
            > self.EXPECTED_RATIO
            and self.zeros_at_mod[2] / approx_chars
            > self.EXPECTED_RATIO
            and self.nonzeros_at_mod[3] / approx_chars
            > self.EXPECTED_RATIO
    ...
    def is_likely_utf32le(self):
        approx_chars = self.approx_32bit_chars()
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            self.nonzeros_at_mod[0] / approx_chars
            > self.EXPECTED_RATIO
            and self.zeros_at_mod[1] / approx_chars
            > self.EXPECTED_RATIO
            and self.zeros_at_mod[2] / approx_chars
            > self.EXPECTED_RATIO
            and self.zeros_at_mod[3] / approx_chars
            > self.EXPECTED_RATIO
    ...
    def is_likely_utf16be(self):
        ...
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            ...
            / approx_chars
            > self.EXPECTED_RATIO
            and (self.zeros_at_mod[0] + self.zeros_at_mod[2])
            / approx_chars
            > self.EXPECTED_RATIO
    ...
    def is_likely_utf16le(self):
        ...
        return approx_chars >= self.MIN_CHARS_FOR_DETECTION and (
            ...
            / approx_chars
            > self.EXPECTED_RATIO
            and (self.zeros_at_mod[1] + self.zeros_at_mod[3])
            / approx_chars
            > self.EXPECTED_RATIO

...
class pyparsing_test:
    ...
    class reset_pyparsing_context:
        ...
        def restore(self):
            ...
            if self._save_context["packrat_enabled"]:
                ...
                ParserElement._parse = self._save_context[
                    "packrat_parse"
                ]
            ParserElement._left_recursion_enabled = (
                self._save_context["recursion_enabled"]
    ...
    def with_line_numbers(
                ...
                tbl = str.maketrans(
                    {
                        c: u
                        for c, u in zip(
                            range(0, 33), range(0x2400, 0x2433)
                        )
                    }
                    | {127: 0x2421}
                )
        ...
        if mark_control != "unicode":
            ...
            s_lines = [
                line + "␊"
                for line in s.split("␊")[start_line - 1 : end_line]
            ]
        if not s_lines:
            return ""
        ...
        header2 = (
            lead + "1234567890" * (-(-max_line_len // 10)) + "\n"
        )
        return (
            header1
            + header2

...
class BaseRetrying(ABC):
    def __init__(
        ...
        before_sleep: t.Optional[
            t.Callable[["RetryCallState"], None]
        ] = None,
        reraise: bool = False,
    ...
    def copy(
        ...
        before: t.Union[
            t.Callable[["RetryCallState"], None], object
        ] = _unset,
        after: t.Union[
            t.Callable[["RetryCallState"], None], object
        ] = _unset,
    ...
    def iter(
        ...
        if not (
            is_explicit_retry or self.retry(retry_state=retry_state)
        ):
            return fut.result()
...
class RetryCallState:
    ...
    def __repr__(self):
        if self.outcome is None:
            ...
            result = (
                f"failed ({exception.__class__.__name__} {exception})"
            )
        else:
...
from pip._vendor.tenacity._asyncio import (
    AsyncRetrying,
)  # noqa:E402,I100

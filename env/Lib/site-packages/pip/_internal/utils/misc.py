...
def captured_output(
    stream_name: str,
) -> Generator[StreamWrapper, None, None]:
...
def split_auth_netloc_from_url(
    ...
    """
    url_without_auth, (netloc, auth) = _transform_url(
        url, _get_netloc
    )
...
class ConfiguredPep517HookCaller(Pep517HookCaller):
    ...
    def build_sdist(
        ...
        return super().build_sdist(
            sdist_directory, config_settings=cs
        )
    ...
    def get_requires_for_build_wheel(
        ...
        cs = self.config_holder.config_settings
        return super().get_requires_for_build_wheel(
            config_settings=cs
        )
    ...
    def get_requires_for_build_sdist(
        ...
        cs = self.config_holder.config_settings
        return super().get_requires_for_build_sdist(
            config_settings=cs
        )
    ...
    def get_requires_for_build_editable(
        ...
        cs = self.config_holder.config_settings
        return super().get_requires_for_build_editable(
            config_settings=cs
        )

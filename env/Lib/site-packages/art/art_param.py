...
ART_ENVIRONMENT_WARNING = (
    "[Warning] '{0}' is not printable in this environment."
)
FONT_ENVIRONMENT_WARNING = (
    "[Warning] '{0}' is not printable in this environment."
)
PACKAGE_LOAD_WARNING = (
    "[Warning] There is a problem loading the package 'coverage'."
)
...
DECORATION_NAMES = sorted(
    list(DECORATIONS_MAP.keys())
)  # pragma: no cover
